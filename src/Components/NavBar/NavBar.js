...
const NavBar = () => {
    ...
    return (
        <div className="navbar h-[70px] lg:h-[97px]">
            <div className="navbar-start">

                <a href='#home' className="text-[24px] lg:text-3xl font-normal text-[#333333] ml-[27px] pt-[18px] pb-[19px] lg:pt-[27px] lg:mb-7">Image Gallery</a>
            </div>
            ...
            <div className="hidden lg:flex ml-[88px] mr-[150px]">
            ...
            <button className="ml-[30%] mr-[13.05px] btn btn-ghost btn-circle lg:hidden">
            ...
            <div className="dropdown dropdown-end mr-[31px]">
                ...
                <ul tabIndex={0} className="mt-3 p-2 shadow menu menu-compact dropdown-content rounded-box w-40">
